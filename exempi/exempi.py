...
if __name__ == '__main__' :
	...
	output_file = "/tmp/test.xmp"

	exempi  = Exempi( "/usr/local/bin/exempi" )

	if exempi.generate( "/gscripts/bdlss/jhove/sample_test_tiffs/oulis2012-azk-0001t-0.tif", output_file ) :
		if os.path.exists( output_file ) :
			print "SUCCESS: Completed XMP extract - File found."
		else :
			print "FAIL: Completed XMP extract - But File NOT found."

	else:
		print "FAIL: Failed XMP extract."
